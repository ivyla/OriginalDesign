...
void scene() {
  ...
  //  noStroke();
  //  fill(255, 255, 255);
  //  ellipse(320, moonY, 40, 40);
  //  //moon reflection
  //  noStroke();
  //  fill(255, 255, 255, 30);
  //  ellipse(320, moonY + 160, 40, 40); 
  ////
  //  // Moon bob alternative 
  //  if (moonY < 70) {
  //    isDown = true;
  //  } else if (moonY > 60) {
  //    isDown = false;
  //  }
  //  if (isDown) {
  //    moonY = lerp(moonY, 72, 0.010);
  //  } else {
  //    moonY = lerp(moonY, 20, 0.15);
  //  }
...
void stars() {
 ...
 // ellipse(60, 100+142, ellipseW, ellipseH);
  ellipse(94, 52+142, ellipseW, ellipseH);
 // ellipse(90, 12+142, ellipseW, ellipseH);
  ellipse(59, 73+142, ellipseW, ellipseH);

  //VALUES GREATER THAN 120, BUT LESS THAN 200. RIGHT HALF OF STARS
  ellipse(137, 38+142, ellipseW, ellipseH);
 // ellipse(146, 83+142, ellipseW, ellipseH);
 // ellipse(188, 69+142, ellipseW, ellipseH);
 // ellipse(169, 53+142, ellipseW, ellipseH);
  //ellipse(180, 88+142, ellipseW, ellipseH);
  //ellipse(174, 17+142, ellipseW, ellipseH); 

  //VALUES GREATER THAN 200, BUT LESS THAN 330. LEFT RIGHT HALF OF STARS
 // ellipse(318, 15+142, ellipseW, ellipseH);  
...
//  ellipse(289, 23+142, ellipseW, ellipseH);

  //GREATER THAN 300
  ellipse(365, 73+142, ellipseW, ellipseH);
  //ellipse(386, 26+142, ellipseW, ellipseH);
  //ellipse(393, 104+142, ellipseW, ellipseH);
//  ellipse(356, 45+142, ellipseW, ellipseH);
  ellipse(330, 100+142, ellipseW, ellipseH);
//  ellipse(335, 117+142, ellipseW, ellipseH);
